...
const CrawlPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      <h1 className="text-2xl font-bold mb-6">Crawl Websites</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
                ...
                <div className="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-4 mt-2">
                  <div className="flex items-center">
                    <input
                      ...
                      disabled={isLoading}
                    />
                    <label htmlFor="followExternal" className="ml-2 block text-sm">
                      Follow External Links
                    </label>
                  </div>
                  
                  <div>
                    <label htmlFor="includePatterns" className="block text-sm font-medium mb-1">
          ...
          <div className="card p-6 mt-6">
            <h2 className="text-xl font-semibold mb-2">Crawling Tips</h2>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                <span className="text-green-500 mr-2">✓</span>
                <span>Start with a low depth (2) and increase if needed</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">✓</span>
                <span>Use include/exclude patterns to focus your crawl</span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-2">✓</span>
                <span>Limit max pages to avoid long processing times</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-500 mr-2">✗</span>
                <span>Avoid crawling login-protected or dynamic content pages</span>
              </li>
              <li className="flex items-start">
                <span className="text-red-500 mr-2">✗</span>
                <span>Don't crawl sites you don't have permission to access</span>
              </li>
            </ul>
          </div>
        </div>
            ...
            {activeCrawls.length === 0 ? (
              ...
              <div className="space-y-4">
                {activeCrawls.map((crawl) => (
                  <div key={crawl.site_id} className="card p-6">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-lg font-medium">{crawl.site_name || crawl.name}</h3>
                    ...
                    {crawl.error && (
                      <div className="mb-4 p-2 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-200 text-sm rounded">
